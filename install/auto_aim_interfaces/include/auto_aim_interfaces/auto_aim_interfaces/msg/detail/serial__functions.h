...
#ifndef AUTO_AIM_INTERFACES__MSG__DETAIL__SERIAL__FUNCTIONS_H_
#define AUTO_AIM_INTERFACES__MSG__DETAIL__SERIAL__FUNCTIONS_H_
 ...
 * calls
 * auto_aim_interfaces__msg__Serial__init().
...
/**
 * It calls
 * auto_aim_interfaces__msg__Serial__fini()
 ...
 * auto_aim_interfaces__msg__Serial__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * auto_aim_interfaces__msg__Serial__Sequence__fini()
 * on the array,
...
#endif  // AUTO_AIM_INTERFACES__MSG__DETAIL__SERIAL__FUNCTIONS_H_
