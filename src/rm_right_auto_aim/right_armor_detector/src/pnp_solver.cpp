...
bool PnPSolver::solvePnP(const Armor & armor, cv::Mat & rvec, cv::Mat & tvec)
{
  ...
  // 平均点法
  /*cv::Point2f left = cv::Point2f((armor.left_light.bottom.x + armor.left_light.top.x)/2,(armor.left_light.bottom.y + armor.left_light.top.y)/2);
  cv::Point2f top = cv::Point2f((armor.left_light.top.x + armor.right_light.top.x)/2,(armor.left_light.top.y + armor.right_light.top.y)/2);
  cv::Point2f right = cv::Point2f((armor.right_light.bottom.x + armor.right_light.top.x)/2,(armor.right_light.bottom.y + armor.right_light.top.y)/2);
  cv::Point2f bottom = cv::Point2f((armor.right_light.bottom.x + armor.left_light.bottom.x)/2,(armor.right_light.bottom.y + armor.left_light.bottom.y)/2);

  image_armor_points.emplace_back(left);
  image_armor_points.emplace_back(top);
  image_armor_points.emplace_back(right);
  image_armor_points.emplace_back(bottom);*/
