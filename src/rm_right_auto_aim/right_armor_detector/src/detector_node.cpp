...
namespace rm_right_auto_aim
{
ArmorDetectorNode::ArmorDetectorNode(const rclcpp::NodeOptions & options)
: Node("left_armor_detector", options)
{
  RCLCPP_INFO(this->get_logger(), "Starting RightDetectorNode!");
  ...
  armors_pub_ = this->create_publisher<auto_aim_interfaces::msg::Armors>(
    "/right_camera/detector/armors", rclcpp::SensorDataQoS());
  ...
  marker_pub_ =
    this->create_publisher<visualization_msgs::msg::MarkerArray>("/right_camera/detector/marker", 10);

  changeyaw_pub = this->create_publisher<auto_aim_interfaces::msg::Bias>("/right_camera/trajectory/changeyaw", 10);
  ...
  img_sub_ = this->create_subscription<sensor_msgs::msg::Image>(
    ...
    "/image_right", rclcpp::SensorDataQoS(),
    std::bind(&ArmorDetectorNode::imageCallback, this, std::placeholders::_1));

  needpose_sub_ = this->create_subscription<geometry_msgs::msg::PointStamped>("/right_camera/tracker/needpose", 10,
    std::bind(&ArmorDetectorNode::needposeCallback, this, std::placeholders::_1));

  armorpose_sub_ = this->create_subscription<geometry_msgs::msg::PointStamped>("/right_camera/tracker/armorpose", 10,
...
void ArmorDetectorNode::imageCallback(const sensor_msgs::msg::Image::ConstSharedPtr img_msg)
{
  ...
  if (pnp_solver_ != nullptr) {
    ...
    armors_msg_.header.stamp =armor_marker_.header.stamp=text_marker_.header.stamp =  this->now();
...
std::unique_ptr<Detector> ArmorDetectorNode::initDetector()
{
  ...
  // Init classifier
  auto pkg_path = ament_index_cpp::get_package_share_directory("right_armor_detector");
...
{
  lights_data_pub_ =
    this->create_publisher<auto_aim_interfaces::msg::DebugLights>("/right_camera/detector/debug_lights", 10);
  armors_data_pub_ =
    this->create_publisher<auto_aim_interfaces::msg::DebugArmors>("/right_camera/detector/debug_armors", 10);

  binary_img_pub_ = image_transport::create_publisher(this, "/right_camera/detector/binary_img");
  number_img_pub_ = image_transport::create_publisher(this, "/right_camera/detector/number_img");
  result_img_pub_ = image_transport::create_publisher(this, "/right_camera/detector/result_img");
}
...
RCLCPP_COMPONENTS_REGISTER_NODE(rm_right_auto_aim::ArmorDetectorNode)
