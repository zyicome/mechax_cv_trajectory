...
namespace front_mindvision_camera
{
class MVCameraNode : public rclcpp::Node
{
public:
  explicit MVCameraNode(const rclcpp::NodeOptions & options) : Node("front_mv_camera", options)
  {
    RCLCPP_INFO(this->get_logger(), "Starting FrontMVCameraNode!");
    ...
    camera_pub_ = image_transport::create_camera_publisher(this, "image_front", qos);

    // Load camera info
    camera_name_ = this->declare_parameter("camera_name", "front_camera");
    camera_info_manager_ =
      std::make_unique<camera_info_manager::CameraInfoManager>(this, camera_name_);
    auto camera_info_url = this->declare_parameter(
      "camera_info_url", "package://front_mindvision_camera/config/camera_info.yaml");
...
RCLCPP_COMPONENTS_REGISTER_NODE(front_mindvision_camera::MVCameraNode)
