...
public:
    ...
    void target_assistant_callback(const auto_aim_interfaces::msg::Target msg);
    ...
    rclcpp::Subscription<auto_aim_interfaces::msg::Target>::SharedPtr target_assistant_sub_;
