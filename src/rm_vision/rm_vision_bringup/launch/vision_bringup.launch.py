...
def generate_launch_description():
    ...
    detector_assistant_node = ComposableNode(
        package='armor_detector_assistant',
        plugin='rm_auto_aim_assistant::ArmorDetectorNode',
        name='armor_detector_assistant',
        parameters=[node_params],
        extra_arguments=[{'use_intra_process_comms': True}],
    )
