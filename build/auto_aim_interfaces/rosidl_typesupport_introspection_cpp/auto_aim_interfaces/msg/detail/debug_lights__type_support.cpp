...
{
  new (message_memory) auto_aim_interfaces::msg::DebugLights(_init);
}

void DebugLights_fini_function(void * message_memory)
{
  auto typed_message = static_cast<auto_aim_interfaces::msg::DebugLights *>(message_memory);
  typed_message->~DebugLights();
}

size_t size_function__DebugLights__data(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<auto_aim_interfaces::msg::DebugLight> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<auto_aim_interfaces::msg::DebugLight> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<auto_aim_interfaces::msg::DebugLight> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const auto_aim_interfaces::msg::DebugLight *>(
    get_const_function__DebugLights__data(untyped_member, index));
  auto & value = *reinterpret_cast<auto_aim_interfaces::msg::DebugLight *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<auto_aim_interfaces::msg::DebugLight *>(
    get_function__DebugLights__data(untyped_member, index));
  const auto & value = *reinterpret_cast<const auto_aim_interfaces::msg::DebugLight *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DebugLights_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<auto_aim_interfaces::msg::DebugLight>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces::msg::DebugLights, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DebugLights_message_members = {
  ...
  1,  // number of fields
  sizeof(auto_aim_interfaces::msg::DebugLights),
...
{
  return &::auto_aim_interfaces::msg::rosidl_typesupport_introspection_cpp::DebugLights_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auto_aim_interfaces, msg, DebugLights)() {
  return &::auto_aim_interfaces::msg::rosidl_typesupport_introspection_cpp::DebugLights_message_type_support_handle;
}
