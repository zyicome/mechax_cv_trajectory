  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: is_shoot
  {
    cdr << (ros_message->is_shoot ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: is_shoot
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->is_shoot = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__Serial;
    is_plain =
      (
...
static size_t _Serial__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__Serial(
