...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__TrackerInfo__rosidl_typesupport_introspection_c__TrackerInfo_message_member_array[4] = {
  {
    "position_diff",  // name
